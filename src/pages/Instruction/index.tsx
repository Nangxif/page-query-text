      ...
      <Typography>
        ...
        >
          <ul>
            ...
            <li>
              大致看了一些插件市场上的相关插件，有些功能太杂乱用户不一定都会用到，使用门槛高。再者，大多类似插件实现文字高亮的方式破坏原本页面的结构，这是我无法接受的。
            </li>
          </ul>
        </Paragraph>
      </Typography>
      <Typography>
        ...
        >
          <ul>
            ...
            <li>
              从左到右的控件依次为：“设置”，“搜索输入框”，“区分大小写搜索”，“是否全匹配关键字”，“关闭”
            </li>
            <li>
              点击“设置”按钮，打开设置面板，可以
              <ul>
            ...
            <li>
              点击“是否全匹配关键字”按钮，可以开启和关闭是否全匹配关键字搜索的功能，比如，如果开启全匹配关键字功能，在检索“你好”关键字时，需要“你好“二字前后为空格或者为标点符号才可命中搜索条件
            </li>
            <li>
